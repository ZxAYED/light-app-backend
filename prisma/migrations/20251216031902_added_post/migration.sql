/*
  ...
  - The values [HELP_REQUEST_ACCEPTED,HELP_REQUEST_REJECTED] on the enum `NotificationType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "NotificationType_new" AS ENUM ('GOAL_CREATED', 'GOAL_UPDATED', 'GOAL_COMPLETED', 'HELP_REQUEST', 'REWARD_UNLOCKED', 'DAILY_REMINDER', 'CHILD_PROGRESS_UPDATE');
